...
func (ctx *ObjectValidationContext) HasFrame(frameType string) bool {
	...
	switch frameType {
	case "ResourceFrame":
		return frames.ResourceFrame != nil
	case "ServiceFrame":
		return frames.ServiceFrame != nil
	case "TimetableFrame":
		return frames.TimetableFrame != nil
	case "SiteFrame":
		return frames.SiteFrame != nil
	case "ServiceCalendarFrame":
		return frames.ServiceCalendarFrame != nil
	case "VehicleScheduleFrame":
		return frames.VehicleScheduleFrame != nil
	default:
		return false
	}
}
